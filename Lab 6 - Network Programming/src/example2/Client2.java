...
public class Client2 {
	...
	public static void main(String[] args) throws UnknownHostException, IOException {
		...
		//to read from the console like scanner
		...
		while(true)
        {
            ...
            if(message.equals("."))//we need to send the "."before break to tell the server to terminate
            	break;
            String convertedMessage = socketReader.readLine();  //read the converted msg from the server
